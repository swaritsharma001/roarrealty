  ...
  {page?.HeroTitle || "Find Your Dream Luxury Home"}
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center px-4">
              <Link href="/properties" className="w-full sm:w-auto">
                <Button 
                  size="lg" 
                  className="w-full sm:w-auto bg-white text-black hover:bg-gray-100 font-semibold text-base md:text-lg px-6 md:px-8 py-4 md:py-6 mb-4 rounded-xl shadow-[4px_4px_0px_0px_rgba(255,255,255,0.3)] hover:shadow-[2px_2px_0px_0px_rgba(255,255,255,0.3)] hover:translate-x-[2px] hover:translate-y-[2px] transition-all duration-300"
                >
